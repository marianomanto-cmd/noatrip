...
// Es la fuente para el primer "seed" en Supabase y para el botón "Restaurar recomendaciones".
...
export const defaultDays = [
  {
    position: 1, date: '2026-07-03', weekday: 'Viernes', title: 'Córdoba → Salta',
    from_place: 'Córdoba', to_place: 'Salta', distance_km: 900, drive_time: '10–11 h',
    ...
    lodging_name: 'Salta — Hotel del Antiguo Convento (centro histórico)', lodging_price: 60,
    lodging_notes: 'Habitación doble.',
  ...
  {
    position: 2, date: '2026-07-04', weekday: 'Sábado', title: 'Salta → Purmamarca',
    from_place: 'Salta', to_place: 'Purmamarca', distance_km: 190, drive_time: '2 h 45',
    ...
    lodging_name: 'Purmamarca — La Comarca / Posada del Sol', lodging_price: 85,
    lodging_notes: 'Con vista a los cerros.',
  ...
  {
    position: 3, date: '2026-07-05', weekday: 'Domingo', title: 'Salinas Grandes → Tilcara',
    from_place: 'Purmamarca', to_place: 'Tilcara', distance_km: 150, drive_time: '4–5 h con paradas',
    ...
    lodging_name: 'Tilcara — Posada de Luz / Las Terrazas (1ª de 2 noches)', lodging_price: 70,
    lodging_notes: '',
  ...
  {
    position: 4, date: '2026-07-06', weekday: 'Lunes', title: 'Tilcara · Humahuaca · Hornocal',
    from_place: 'Tilcara', to_place: 'Tilcara', distance_km: 150, drive_time: '3–4 h al volante',
    ...
    lodging_name: 'Tilcara — mismo alojamiento (2ª noche)', lodging_price: 70,
    lodging_notes: '',
  ...
  {
    position: 5, date: '2026-07-07', weekday: 'Martes', title: 'Tilcara → Salta (ciudad)',
    from_place: 'Tilcara', to_place: 'Salta', distance_km: 190, drive_time: '~3 h',
    ...
    lodging_name: 'Salta capital — hotel céntrico', lodging_price: 60,
    lodging_notes: '',
    extra_costs: [{ label: 'Comida (2)', amount: 55 }, { label: 'Nafta', amount: 23 }, { label: 'MAAM + teleférico', amount: 20 }],
    notes: '',
  },
  {
    position: 6, date: '2026-07-08', weekday: 'Miércoles', title: 'Salta → Cachi',
    from_place: 'Salta', to_place: 'Cachi', distance_km: 160, drive_time: '4–4.5 h',
    ...
    lodging_name: 'Cachi — El Cortijo Hotel Boutique / ACA Hostería', lodging_price: 90,
    lodging_notes: '',
  ...
  {
    position: 7, date: '2026-07-09', weekday: 'Jueves', title: 'Cachi → Cafayate',
    from_place: 'Cachi', to_place: 'Cafayate', distance_km: 160, drive_time: '4–5 h',
    ...
    lodging_name: 'Cafayate — Hotel Killa / Viñas de Cafayate', lodging_price: 95,
    lodging_notes: '',
  ...
  {
    position: 8, date: '2026-07-10', weekday: 'Viernes', title: 'Cafayate → Q. de las Conchas → Salta',
    from_place: 'Cafayate', to_place: 'Salta', distance_km: 185, drive_time: '3 h (5–6 h con paradas)',
    ...
    lodging_name: 'Salta capital — vuelta para el cierre', lodging_price: 60,
    lodging_notes: '',
  ...
  {
    position: 9, date: '2026-07-11', weekday: 'Sábado', title: 'Salta · último día',
    from_place: 'Salta', to_place: 'Salta', distance_km: 20, drive_time: 'Día urbano',
    ...
    lodging_name: 'Salta capital — última noche', lodging_price: 60,
    lodging_notes: '',
    extra_costs: [{ label: 'Comida (2)', amount: 60 }, { label: 'Nafta', amount: 5 }],
    notes: '',
  },
  {
    position: 10, date: '2026-07-12', weekday: 'Domingo', title: 'Salta → Córdoba',
    from_place: 'Salta', to_place: 'Córdoba', distance_km: 900, drive_time: '10–11 h',
    terrain: 'Asfalto · peajes', max_altitude: '', photo_url: IMG.cordoba,
    activities: [
    ...
    lodging_name: 'En casa 🏠 — fin del viaje', lodging_price: 0,
    lodging_notes: '',
    extra_costs: [{ label: 'Comida (2)', amount: 55 }, { label: 'Nafta', amount: 108 }, { label: 'Peajes', amount: 15 }],
